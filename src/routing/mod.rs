...
pub fn generate_dynamic_static_routes(folder: &str) -> BoxedFilter<(Result<Response<String>, Error>,)> {
    let pages_dir = folder; // Pasta onde os arquivos estão
